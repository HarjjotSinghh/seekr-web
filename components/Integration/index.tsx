  ...
  return (
    <>
      <section>
        ...
        <div className="pattern-dots pattern-blue-500 pattern-bg-background pattern-size-4 pattern-opacity-10 relative z-50 mx-auto mt-15 max-w-c-1154 px-4 md:px-8 xl:mt-20 xl:px-0">
          ...
          <div className="flex flex-wrap justify-around gap-y-10">
            ...
            >
              <div className="bg-background inline-block rounded-[10px] p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
