...
const Footer = () => {
  return (
    <>
      <footer className="bg-background dark:bg-backgroundsection border-t border-stroke dark:border-strokedark">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                <a href="index.html" className="relative w-full">
                  <Image
                    width={110}
                    height={80}
                ...
                <p className="mb-10 mt-3">AI-Guided Careers, Just For You</p>

                <p className="mb-1 text-sectiontitle uppercase tracking-[5px]">
                  contact us at
                </p>
                <a
                  href="#"
                  className="text-foreground dark:text-foreground text-itemtitle font-medium"
                >
                  hello@seekr.one
                </a>
              </motion.div>

              <div className="flex w-full flex-col gap-8 sm:justify-start md:flex-row md:gap-32 lg:w-2/3 lg:justify-end xl:w-7/12">
                <motion.div
                  variants={{
                    hidden: {
                      opacity: 0,
                  ...
                  className="animate_top"
                >
                  <h4 className="text-foreground dark:text-foreground mb-4 text-itemtitle2 font-medium">
                    Quick Links
                  </h4>
                  ...
                  <ul>
                    <li>
                      <a
                        href="#"
                        className="mb-3 inline-block transition-all duration-300 ease-in-out hover:text-primary"
                      >
                        Home
                      </a>
                    </li>
                  ...
                  <form action="#">
                    <div className="relative">
                      <input
                        ...
                        className="dark:bg-background w-full rounded-full border border-stroke px-6 py-3 shadow-solid-11 focus:border-primary focus:outline-none dark:border-strokedark dark:shadow-none dark:focus:border-primary"
                      />
          ...
          {/* <!-- Footer Bottom --> */}
          <div className="flex flex-col flex-wrap items-center justify-start gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            <motion.div
              variants={{
                hidden: {
                  opacity: 0,
